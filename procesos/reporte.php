...
if(isset($aceptar))
{
    ...
    elseif($tipo_reporte == "Por cedula")
    {
        ...
        else
        {
            ...
            header("Location:../modulos/reportes.php");
            die();
        }
    }
...
<b><center>DOCENTES</center></b><br>
 ...
 <tr class="color">
    ...
    <?php if($foto == "Incluir foto"){ ?>
    <th width="15%">Foto entrada</th>
    <th width="15%">Foto salida</th>
    <?php } ?>
...
<?php if($foto == "Incluir foto"){ ?>
<td><img width="120px" src="<?=$row['foto_entrada']?>" alt="Sin foto"></td>
<td><img width="120px" src="<?=$row['foto_salida']?>" alt="Sin foto"></td>
<?php } ?>
</tr>
<?php } ?>
